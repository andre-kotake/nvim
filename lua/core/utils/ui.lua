...
function M.toggle_foldcolumn()
  ...
  vim.wo.foldcolumn = curr_foldcolumn == "0" and (last_active_foldcolumn or "1")
    or "0"
...
---Toggle icons in custom keymaps description
---@param enable boolean
function M.toggle_keymap_desc_icons(enable)
  vim.g.enable_keymap_desc_icons = enable
end
